...
<head>
    ...
    <link rel="stylesheet" href="css/admin/layuimini.css?v=2.0.4.2" media="all">
    <link rel="stylesheet" href="css/admin/themes/default.css" media="all">
...
<script>
    layui.use(['jquery', 'layer', 'miniAdmin','miniTongji'], function () {
        ...
        var options = {
            iniUrl: "admincp.php/home/get_init_data",    // 初始化接口
            clearUrl: "admincp.php/home/clear_session", // 缓存清理接口
        ...
        $('.login-out').on("click", function () {
            layer.msg('退出登录成功', {time: 1000, icon: 4}, function () {
                window.location = 'admincp.php/admin/logout.html';
            });
        });
    });
</script>
