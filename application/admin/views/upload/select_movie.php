...
<a href="admincp.php/upload/select/<?php echo substr($cusPath, 0, -5); ?>">返回上级目录</a>
<?php }} ?>
</td>
</tr>
</table>
...
<tr>
 ...
 <a href="admincp.php/upload/select/<?php echo $cusPath . $value["fileName"] . "_" ; ?>"><?php echo $value["fileName"];?></a> 
 <?php } else if ($value["fileType"] == "file") {?>
 <img src="images/admin/jpg.gif" /> <?php echo $value["fileName"];?><br/>
 <a href="#" onclick="javascript:selectImage('<?php echo $path . $value["fileName"]; ?>');">
