...
<div class="member_right mt20">
    <div class="box_shadow clearfix m_border">
        <div class="member_title"><span class="bt">发布吆喝商品</span></div>
        <div class="hd">
            <ul>
                <li class="on">商品信息</li>
                <li>商品描述</li>
        ...
        <!-- <ul class="m_form" style="padding-left:0px;">
            <li class="clearfix"><span>套餐商品：</span><div class="xm-select fl">
                    <div class="dropdown">
                        <label class="iconfont" for="category_id"></label>
                           <select class="input_blur" name="category_id">
                                    <option value="" >请选择套餐商品</option>
                               <?php if (! empty($store_type_list)) { ?>
                                   <?php foreach ($store_type_list as $menu) {
                                       $selector = '';
                                       if ($item_info) {
                                           if ($menu['id'] == $item_info['category_id']) {
                                               $selector = 'selected="selected"';
                                           }
                                       }
                                       ?>
                                       <option value="<?php echo $menu['id']; ?>" <?=$selector?>><?php echo $menu['name']; ?></option>
...
<!--                </a>-->
            ...
            <ul class="m_form fl" style="width:67%;">
                <li class="clearfix"><span>商品名称：</span><input type="text" name="title" value="<?php if($item_info){ echo $item_info['name'];} ?>" id="title" valid="required" errmsg="商品名称不能为空!" class="input_txt"><font color="#cc0011">*</font></li>
                <!-- <li class="clearfix"><span>商品关键字：</span><input type="text" name="keyword" value="<?php if($item_info){ echo $item_info['keyword'];} ?>" id="keyword" class="input_txt" placeholder="多个关键词用英文逗号,相隔"> -->
                <li class="clearfix" id="pri_input"><span>价格：</span><input type="text" name="price" value="<?php if($item_info){ echo $item_info['price'];} ?>" id="sell_price" class="input_txt" valid="isNumber" errmsg="请正确填写价格!" style="width: 100px">&nbsp;元</li>
                <li class="clearfix" id="pri_input"><span>原价：</span><input type="text" name="original_price" value="<?php if($item_info){ echo $item_info['original_price'];} ?>" id="original_price" class="input_txt" valid="isNumber" errmsg="请正确填写价格!" style="width: 100px">&nbsp;元</li>
                <li class="clearfix" id="pri_input"><span>佣金：</span><input type="text" name="reward" value="<?php if($item_info){ echo $item_info['reward'];} ?>" id="reward" class="input_txt" valid="isNumber" errmsg="请正确填写佣金!" style="width: 100px">&nbsp;元</li>
                <li class="clearfix" id="pri_input"><span>库存：</span><input type="text" name="stock" value="<?php if($item_info){ echo $item_info['stock'];} ?>" id="stock" class="input_txt" valid="isNumber" errmsg="库存请填写大于0的数字!" style="width: 100px"></li>
