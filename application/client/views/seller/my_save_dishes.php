                    ...
                    <div class="dropdown">
                        <label class="iconfont" for="category_id"></label>
                           <select class="input_blur" name="category_id">
                               ...
                               <?php if (! empty($dishes_category_list)) { ?>
                                   <!-- 一级 -->
                                   <?php foreach ($dishes_category_list as $menu) {
                                       $selector = '';
                                       if ($item_info) {
...
<!--                </a>-->
            ...
            <ul class="m_form fl" style="width:67%;">
                ...
                <li class="clearfix">
                <span>商品类型：</span>
                        <label><input name="type" value="0" type="radio" size="10" <?php if(empty($item_info) || $item_info['type'] == 0){ echo 'checked="checked"';} ?>> 仅美食菜品</label>
                        <label><input name="type" value="1" type="radio" size="10" <?php if(! empty($item_info) && $item_info['type'] == 1){ echo 'checked="checked"';} ?>> 仅外卖商品</label>
                        <label><input name="type" value="2" type="radio" size="10" <?php if(! empty($item_info) && $item_info['type'] == 2){ echo 'checked="checked"';} ?>> 两者皆是</label>
                </li>
                <li class="clearfix">
                <span>属性：</span>
                        <label><input name="attribute[]" value="tj" type="checkbox" size="10" <?php if($item_info && in_array('tj', explode(',', $item_info['attribute']))){ echo 'checked="checked"';} ?>> 推荐</label>
                </li>
