...
class WxPayApi
{
    /**
     *
     * 企业付款，WxPayTransfers中mch_appid、mchid、nonce_str、partner_trade_no、openid、check_name、amount、desc必填
     * @param WxPayTransfers $inputObj
     * @param int $timeOut
     * @throws WxPayException
     * @return 成功时返回，其他抛异常
     */
    public static function transfers($inputObj, $timeOut = 6, $is_xcx = 0)
    {
        $url = "https://api.mch.weixin.qq.com/mmpaymkttransfers/promotion/transfers";
        //检测必填参数
        if(!$inputObj->IsMch_appidSet()) {
            throw new WxPayException("缺少企业付款接口必填参数mch_appid！");
	 ...
	 * @return 成功时返回，其他抛异常
	 */
	public static function refund($inputObj, $timeOut = 6, $is_xcx = 0)
	{
	...
	//退款--sxh
	public function do_refund($transaction_id = '', $out_trade_no = '', $out_refund_no = '', $total_fee = 0, $refund_fee = 0, $is_xcx = 0)
	{
		...
		$result = $this->refund($input,6,$is_xcx);//self::refund()
		return $result;
	}
